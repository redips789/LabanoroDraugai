...
@NamedQueries({
    @NamedQuery(name = "Recommendation.deleteById", query = "DELETE FROM Recommendation r WHERE r.recommendationPK.receiverAccountid = :receiverAccountid"),
    @NamedQuery(name = "Recommendation.findForConfirm", query = "SELECT r FROM Recommendation r WHERE r.recommendationPK.giverAccountid = :giverAccountid and r.isGiven = :isGiven"),
    ...
    @NamedQuery(name = "Recommendation.findByBothId", query = "SELECT r FROM Recommendation r WHERE r.recommendationPK.receiverAccountid = :receiverAccountid and r.recommendationPK.giverAccountid = :giverAccountid"),
    @NamedQuery(name = "Recommendation.findByIsGiven", query = "SELECT r FROM Recommendation r WHERE r.isGiven = :isGiven"),
    @NamedQuery(name = "Recommendation.findByOldRecDate", query = "SELECT r FROM Recommendation r WHERE r.sendDate <= :sendDate"),
